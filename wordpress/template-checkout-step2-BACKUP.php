...
if ($_POST['formsubmit']){
    ...
    if($exequery){
		...
		//header('Location:http://192.155.246.146:8225/checkout-step-2/');exit;
     }
	...
	INNER JOIN wp_state_zone as statetable ON addresstable.shipping_state = statetable.id where session_id = '".$sessionid."'";
...
echo $shipping_firstname.' '.$shipping_lastname;
echo '<br/>';
echo $shipping_addr1;
echo '<br/>';
...
<div class="form-group"><label class="control-label col-lg-5" for="inputFirstName">First Name</label>
<div class="col-lg-7"><input id="billing_inputFirstName" name="billing_inputFirstName" class="form-control" type="text" value="<?php echo $firstname;?>"/></div>
</div>
<div class="form-group"><label class="control-label col-lg-5" for="inputLastName">Last Name</label>
<div class="col-lg-7"><input id="billing_inputLastName" name="billing_inputLastName" class="form-control" type="text" value="<?php echo $lastname;?>"/></div>
</div>
<div class="form-group"><label class="control-label col-lg-5" for="inputAddress1">Address 1</label>
<div class="col-lg-7"><input id="billing_inputAddress1" name="billing_inputAddress1" class="form-control" type="text" value="<?php echo $addr1;?>"/></div>
</div>
<div class="form-group"><label class="control-label col-lg-5" for="inputAddress2">Address 2</label>
<div class="col-lg-7"><input id="billing_inputAddress2" name="billing_inputAddress2" class="form-control" type="text" value="<?php echo $addr2;?>"/></div>
</div>
<div class="form-group"><label class="control-label col-lg-5" for="inputCity">City</label>
<div class="col-lg-7"><input id="billing_inputCity" name="billing_inputCity" class="form-control" type="text" value="<?php echo $city;?>"/></div>
</div>
<div class="form-group"><label class="control-label col-lg-5" for="inputState">State</label>
...
<div class="form-group"><label class="control-label col-lg-5" for="inputZipCode">Zip Code</label>
<div class="col-lg-7"><input id="billing_inputZipCode" name="billing_inputZipCode" class="form-control" type="text" value="<?php echo $zipcode;?>"/></div>
</div>
<div class="form-group"><label class="control-label col-lg-5" for="inputEmail">Email</label>
<div class="col-lg-7"><input id="billing_inputEmail" name="billing_inputEmail" class="form-control" type="email" value="<?php echo $email;?>"/></div>
</div>
<div class="form-group"><label class="control-label col-lg-5" for="inputConfirmEmail">Confirm Email</label>
<div class="col-lg-7"><input id="billing_inputConfirmEmail" name="billing_inputConfirmEmail" class="form-control" type="email" value="<?php echo $email;?>"/></div>
</div>
<div class="form-group"><label class="control-label col-lg-5" for="inputPhone">Phone</label>
<div class="col-lg-7"><input id="billing_inputPhone" name="billing_inputPhone"  class="form-control" type="text" value="<?php echo $phone_no;?>"/></div>
</div>
</div>
<div style="color:red;"><?php if(isset($errors['error_code'])){ echo $errors['error_code'] ;} ?></div>

<h2 class="voffset">Payment Information</h2>
<div class="form-group"><label class="control-label col-lg-5" for="inputCardholderName">Cardholder Name</label>
<div class="col-lg-7"><input id="inputCardholderName" name="inputCardholderName"  class="form-control" type="text" />
<div style="color:red;"><?php if(isset($errors['ccname'])){ echo $errors['ccname'] ;} ?></div>
</div>
</div>
<div class="form-group"><label class="control-label col-lg-5" for="inputCardNumber">Card Number</label>
<div class="col-lg-7"><input id="inputCardNumber" name="inputCardNumber" class="form-control" type="text" />
<div style="color:red;"><?php if(isset($errors['card'])){ echo $errors['card'] ;} ?></div>
</div>
</div>
<div class="form-group"><label class="control-label col-lg-5" for="inputExpirationDate">Expiration Date</label>
<div class="col-lg-7"><select id="Month" class="form-control" name="expMonth" style="width: 106px;">
...
<div class="form-group"><label class="control-label col-lg-5" for="inputCardID">Card ID</label>
<div class="col-lg-7"><input id="inputCardID" name="inputCardID" class="form-control" type="text" />
...
<div class="border cancellation-info voffset">For your convenience, change or cancel at anytime before shipment.</div>
	...
	foreach ( $result as $row ) {
		...
		if($row['pet_type']==0) { ?>
		  <div class="order-type">Recurs Every <?php echo $row['weeks']; ?> Weeks</div>     
		  <ul class="order-detail">
